                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body border-bottom">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 mb-2">
                                            <label class="form-label mt-2">คำขอแยกตามประเภท :</label>
                                            <select class="form-control" name="export_type" data-trigger id="choices-single-groups">
                                                <option value="">กรุณาเลือก</option>
                                                <option value="1" <?php echo ((isset($_GET['export_type']) && $_GET['export_type'] === '1') ? 'selected' : ''); ?>>แยกยุทธ์</option>
                                                <option value="2" <?php echo ((isset($_GET['export_type']) && $_GET['export_type'] === '2') ? 'selected' : ''); ?>>แยกวงเว็บ</option>
                                                <option value="4" <?php echo ((isset($_GET['export_type']) && $_GET['export_type'] === '4') ? 'selected' : ''); ?>>ส่งออก งบประมาณ</option>
                                                <option value="3" <?php echo ((isset($_GET['export_type']) && $_GET['export_type'] === '3') ? 'selected' : ''); ?>>ส่งออก กรอบงบประมาณ</option>
                                            </select>
                                        </div>
                                        <div class="col-xl-12">
                                            <div class="text-center">
                                                <button class="btn btn-primary m-1"><i class="bi bi-search me-1 fw-semibold align-middle"></i>ค้นหา</button>
                                                <a href="business-budget-report-list.php" id="resetBtn" class="btn btn-warning m-1" fdprocessedid="aly3wf"><i class="bi bi-eraser-fill me-1 fw-semibold align-middle"></i>ล้างการค้นหา</a>
                                                ...
                                                <!--<a class="btn btn-success m-1" href="business-budget-form.php"><i class="ri-add-fill me-1 fw-semibold align-middle"></i> ส่งข้อมูลออก เพื่อนำเข้า SAP</a>-->
                                            </div> 
                                        </div>
                                    </div>
                                    </form>
