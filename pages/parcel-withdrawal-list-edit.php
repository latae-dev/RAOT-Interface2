...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">แก้ไขแผนการเบิกพัสดุแบบพิมพ์</h1>
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">ระบบบริหารจัดการข้อมูลพัสดุ</a></li>
                    <li class="breadcrumb-item active" aria-current="page">แก้ไขแผนการเบิกพัสดุแบบพิมพ์</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="px-4 py-3 border-block-start-dashed d-sm-flex justify-content-end">
                    ...
                    <button id="updateSave" class="btn btn-primary btn-wave waves-effect waves-light m-1">
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/parcel-withdrawal-list-edit.js"></script>