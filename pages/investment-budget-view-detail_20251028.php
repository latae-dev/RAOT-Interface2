                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body view-section">
                        <div class="row gy-4 gx-3">
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="view-field">
                                    <label class="view-label">สาขา</label>
                            ...
                            <div class="col-xl-6 col-lg-6" id="submission-info" style="display: none;">
                                <div class="view-field">
                                    <label class="view-label">วันที่ส่งอนุมัติ</label>
                                    <div class="view-value" id="submitted-at">-</div>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6" id="approved-info" style="display: none;">
                                <div class="view-field">
