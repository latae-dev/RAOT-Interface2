...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div>
            <h1 class="page-title fw-semibold fs-18 mb-0">รายการแผนการเบิกพัสดุแบบพิมพ์</h1>
            <div class="mt-2">
        ...
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item fw-semibold active" aria-current="page">รายการแผนการเบิกพัสดุแบบพิมพ์</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div class="card-title">รายการแผนการเบิกพัสดุแบบพิมพ์</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="text-center">
                                <a class="btn btn-success m-1" href="parcel-withdrawal-plan.php"><i class="ri-add-fill me-1 fw-semibold align-middle"></i>กำหนดแผนการเบิกพัสดุแบบพิมพ์</a>
                            ...
                            <table class="table text-nowrap table-bordered">
                                <thead class="text-center">
                                    <tr>
                                        ...
                                        <th scope="col">รหัสรายการแผนการเบิกพัสดุ</th>
                                        <th scope="col">รายการ</th>
                                        <th scope="col">สถานะการส่งอนุมัติ</th>
                                        <th scope="col">สร้างเอกสารใบเบิกพัสดุ (ไตรมาส)</th>
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/parcel-withdrawal-list.js"></script>