...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div>
            <h1 class="page-title fw-semibold fs-18 mb-0">รายละเอียดใบเบิกเบิกพัสดุแบบพิมพ์</h1>
            <div class="mt-2">
        ...
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item fw-semibold active" aria-current="page">ใบเบิกเบิกพัสดุแบบพิมพ์</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    <div class="card-title">เลขที่เอกสาร: <span name="doc_number"></span></div>
                    <div style="font-size:medium"><b>
                        <span  style="border-radius: 5px;" class="bg-light"><span style="padding: 10px;" name="status_doc"></span></span> 
                    </b></div>
                </div>
                        ...
                        <div class="col-xl-3 mb-2">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input disabled name="doc_start" type="text" class="form-control" id="date" placeholder="กำหนด วันเริ่มต้น">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 mb-2">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <!-- <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div> -->
                                    <input disabled name="doc_end" type="text" class="form-control" id="date" placeholder="กำหนด วันสิ้นสุด">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 mb-2">
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="input-group input-group-sm mb-3">
                                                    ...
                                                    <input disabled name="time_deli_doc" type="text" class="form-control flatpickr-input" id="timepickr1" placeholder="กรุณากรอก เวลาส่งตามแผน" readonly="readonly">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input disabled name="time_pick_doc" type="text" class="form-control flatpickr-input" id="timepickr1" placeholder="กรุณากรอก เวลาในการรับส่ง" readonly="readonly">
                                                    <!-- <div class="input-group-text text-muted"> <i class="ri-time-line"></i></div> -->
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="px-4 py-3 border-block-start-dashed d-sm-flex justify-content-end">
                    <a class="btn btn-warning btn-wave waves-effect waves-light m-1" href="parcel-doc-list-approvel.php"><i class='bx bx-undo'></i></i> ย้อนกลับเมนู</a>
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/parcel-doc-list-approvel-detail.js"></script>