...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div>
            <h1 class="page-title fw-semibold fs-18 mb-0">การอนุมัติรวมแผนการเบิกพัสดุแบบพิมพ์</h1>
            <div class="mt-2">
        ...
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item fw-semibold active" aria-current="page">การอนุมัติรวมแผนการเบิกพัสดุแบบพิมพ์</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div class="card-title">การอนุมัติรวมแผนการเบิกพัสดุแบบพิมพ์</div>
                ...
                <div class="card-body border-bottom">
                    ...
                    <div class="row">
                        <div class="col-xl-12 mt-3">
                            <button id="mercData" style="display: none;" class="btn btn-primary m-1">รวมข้อมูล</button>
                        </div>
                    </div>
                </div>
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/parcel-withdrawal-approvel-plan-merge.js"></script>