...
<div class="container-fluid">
    ...
    <div id="main-content" style="display: none;">
        ...
        <div class="row d-none" id="budget-approval-row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div class="card-title mb-0">การพิจารณาอนุมัติงบประมาณ</div>
                    ...
                    <div class="card-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-xl-4">
                                ...
                                <input type="number" class="form-control" id="budget-approval-amount" placeholder="กรอกจำนวนเงิน">
                            </div>
                            <div class="col-xl-12">
                        ...
                        <div class="d-flex justify-content-end flex-wrap mt-3" id="budget-approval-actions">
