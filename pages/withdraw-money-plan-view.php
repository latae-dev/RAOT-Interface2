                ...
                <div class="card custom-card">
                                    ...
                                    <table class="table text-nowrap table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" scope="col" style="width: 100px;">หน่วย</th>
                    ...
                    <div class="card-body px-2 py-4 px-sm-4 border-bottom">
                        <div class="row">
                            <div class="col-xl-3">
                                <div class="form-check mb-2">
                                    <input class="form-check-input day_return" type="checkbox" value="" id="day_return" readonly>
                                    <label class="form-check-label" for="day_return">นับจากวันกลับมาถึง</label>
                                </div>
                                <div class="form-check mb-2">
                                    <input class="form-check-input money_receipt" type="checkbox" value="" id="money_receipt" readonly>
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/withdraw-money-plan-view.js"></script>