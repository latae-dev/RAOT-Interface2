...
<style>
    ...
    .status-badge {
        font-size: 1.125rem; /* ขนาดเท่าหัวข้อ (ประมาณ 18px) */
...
<div class="container-fluid">
    ...
    <div id="main-content" style="display: none;">
                            ...
                            <div class="col-xl-4">
                                <div class="approval-radio-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="approval-action" id="approval-action-approve" value="approve">
                                        <label class="form-check-label" for="approval-action-approve">อนุมัติ</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="approval-action" id="approval-action-reject" value="reject">
                                        <label class="form-check-label" for="approval-action-reject">ไม่อนุมัติ</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-8">
        ...
        <div class="row mt-3 d-none" id="budget-approval-row">
            <div class="col-xl-12">
                <div class="card custom-card">
...
<script>
    ...
    // บังคับโหมดพิจารณางบประมาณเพื่อให้ฟอร์มเปิดให้กรอกได้
