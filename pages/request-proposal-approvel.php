...
<?php ob_start(); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">อนุมัติใบขอเสนอ</h1>
                        <div class="ms-md-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">ระบบจัดซื้อ</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">อนุมัติใบขอเสนอ</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    <div class="card-title">แบบฟอร์มอนุมัติใบขอเสนอ</div>
                                </div>
                        ...
                        <div class="col-xl-12">
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="px-4 py-3 border-block-start-dashed d-sm-flex justify-content-end">
                                    <a href="request-proposal-approvel-list.php" class="btn btn-warning btn-wave waves-effect waves-light m-1"><i class="bi bi-arrow-return-left"></i> ย้อนกลับเมนู</a>
                                    <button class="btn btn-success btn-wave waves-effect waves-light m-1" id="submit-approval-btn"><i class="bi bi-send"></i> ผลการพิจารณา</button>
                                </div> 
                            </div> 
                        </div>
                    </div>
...
<?php ob_start(); ?>
        ...
        <script src="<?php echo $baseUrl; ?>/pages/js/request-proposal-approvel.js"></script>
