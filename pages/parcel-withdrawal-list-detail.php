        ...
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item fw-semibold active" aria-current="page">รายละเอียดแผนการเบิกพัสดุแบบพิมพ์</li>
                </ol>
            </nav>
        </div>
    </div>
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/parcel-withdrawal-list-detail.js"></script>