...
<?php ob_start(); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">รายการคำขอเบิกเงินทดรองจ่าย</h1>
                        <div class="ms-md-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item fw-semibold"><a href="javascript:void(0);">ระบบเงินสดย่อยและเงินทดรองจ่าย</a></li>
                                    <li class="breadcrumb-item fw-semibold active" aria-current="page">รายการคำขอเบิกเงินทดรองจ่าย</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                ...
                                <!-- ส่วนหัว รายการคำขอเบิกเงินทดรองจ่าย -->
                                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    <div class="card-title">รายการคำขอเบิกเงินทดรองจ่าย</div>
                                </div>
                                ...
                                <div class="card-body border-bottom">
                                    <div class="row">
                                        <div class="col-xl-3 mb-2">
                                            <label class="form-label mt-2">รหัสแผนคำขอเบิกเงินทดรอง :</label>
                                            <input type="text" class="form-control" id="input-label11" placeholder="กรุณากรอก รหัสแผนคำขอเบิกเงินทดรอง">
                                        </div>
                                        <div class="col-xl-3 mb-2">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="text-center">
                                                <a class="btn btn-success m-1" href="withdraw-money-plan.php"><i class="ri-add-fill me-1 fw-semibold align-middle"></i>แผนคำขอเบิกเงินทดรองจ่าย</a>
                                ...
                                <!-- List รายการคำขอเบิกเงินทดรองจ่าย -->
                                <div class="card-body border-bottom">
                                    <div class="row">
                                            ...
                                            <table class="table text-nowrap table-bordered">
                                                <thead class="text-center">
                                                    <tr>
                                                        ...
                                                        <th scope="col">ส่งใบสำคัญขอเบิกเงินค่าใช้จ่าย</th>
                                                ...
                                                <tbody>
                                                    <tr class="crm-contact text-center">
                                                        ...
                                                        <td>
                                                            <div class="btn-list">
                                                                <a href="travel-expenses-money.php" class="btn btn-success-light btn-sm">ส่งเงินยืมทดรองจ่าย</a>
                                                                <a href="travel-expenses-money-equ.php" class="btn btn-success-light btn-sm">ส่งเงินยืมทดรองจ่าย (บุคคลภายนอก)</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr class="crm-contact text-center">
                                                        ...
                                                        <td>
                                                            <div class="btn-list">
                                                                <a href="travel-expenses-money.php" class="btn btn-success-light btn-sm disabled">ส่งเงินยืมทดรองจ่าย</a>
                                                                <a href="travel-expenses-money-equ.php" class="btn btn-success-light btn-sm disabled">ส่งเงินยืมทดรองจ่าย (บุคคลภายนอก)</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="hstack gap-2 fs-15">
