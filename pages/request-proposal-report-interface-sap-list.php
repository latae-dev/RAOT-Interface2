...
<?php ob_start(); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">รายงานคำขอสร้างใบขอเสนอ (เชื่อมโยง SAP)</h1>
                        <div class="ms-md-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">ระบบจัดซื้อ</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">รายงานคำขอสร้างใบขอเสนอ (เชื่อมโยง SAP)</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    <div class="card-title">รายงานคำขอสร้างใบขอเสนอ (เชื่อมโยง SAP)</div>
                                            ...
                                            <table id="proposalsTable" class="table text-nowrap table-bordered">
                                                <thead class="text-center">
                                                    <tr>
                                                        ...
                                                        <th scope="col" style="width:150px;">สถานะ Interface SAP</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
...
<?php ob_start(); ?>
        ...
        <script src="<?php echo $baseUrl; ?>/pages/js/request-proposal-list-report-sap.js"></script>
