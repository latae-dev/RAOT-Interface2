...
<div id="investment-budget-form-container" class="container-fluid needs-validation" novalidate>
    ...
    <div id="investment-budget-form-content" class="d-none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="col-xl-12 mb-2">
                                    <label for="pdf-attachments-1" class="form-label mt-2">เอกสารแนบ: (PDF)</label>
                                    <input class="form-control" type="file" id="pdf-attachments-1" name="pdf_attachments" accept=".pdf" data-attachment-input="true">
                    ...
                    <div class="card-body border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="col-xl-12 mb-2">
                                    <label for="pdf-attachments-2" class="form-label mt-2">เอกสารแนบ: (PDF)</label>
                                    <input class="form-control" type="file" id="pdf-attachments-2" name="pdf_attachments" accept=".pdf" data-attachment-input="true">
                                    <div class="existing-attachments mt-2" data-attachment-list></div>
                                    <div class="invalid-feedback">
                                        หากมีไฟล์ประกอบสามารถแนบ PDF ได้
                                    </div>
                    ...
                    <div class="card-body border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="col-xl-12 mb-2">
                                    <label for="pdf-attachments-3" class="form-label mt-2">เอกสารแนบ: (PDF)</label>
                                    <input class="form-control" type="file" id="pdf-attachments-3" name="pdf_attachments" accept=".pdf" data-attachment-input="true">
                                    <div class="existing-attachments mt-2" data-attachment-list></div>
                                    <div class="invalid-feedback">
                                        หากมีไฟล์ประกอบสามารถแนบ PDF ได้
                                    </div>
                    ...
                    <div class="card-body border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="col-xl-12 mb-2">
                                    <label for="pdf-attachments-4" class="form-label mt-2">เอกสารแนบ: (PDF)</label>
                                    <input class="form-control" type="file" id="pdf-attachments-4" name="pdf_attachments" accept=".pdf" data-attachment-input="true">
                                    <div class="existing-attachments mt-2" data-attachment-list></div>
                                    <div class="invalid-feedback">
                                        หากมีไฟล์ประกอบสามารถแนบ PDF ได้
                                    </div>
                ...
                <div class="card custom-card" data-asset-type-id="5" style="display: none;">
                    ...
                    <div class="card-body border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-12 mb-2">
                                <label for="pdf-attachments-5" class="form-label mt-2">เอกสารแนบ: (PDF)</label>
                                <input class="form-control" type="file" id="pdf-attachments-5" name="pdf_attachments" accept=".pdf" data-attachment-input="true">
                                <div class="existing-attachments mt-2" data-attachment-list></div>
                                <div class="invalid-feedback">
                                    หากมีไฟล์ประกอบสามารถแนบ PDF ได้
                                </div>
                ...
                <div class="card custom-card" data-asset-type-id="6" style="display: none;">
                    ...
                    <div class="card-body border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-12 mb-2">
                                <label for="pdf-attachments-6" class="form-label mt-2">เอกสารแนบ: (PDF)</label>
                                <input class="form-control" type="file" id="pdf-attachments-6" name="pdf_attachments" accept=".pdf" data-attachment-input="true">
                                <div class="existing-attachments mt-2" data-attachment-list></div>
        ...
        <select class="form-control installment-count-select" name="installment-count-select-7" id="installment-count-select-7">
                                ...
                                <div class="col-xl-12 mb-2">
                                    <label for="pdf-attachments-7" class="form-label mt-2">เอกสารแนบ: (PDF)</label>
                                    <input class="form-control" type="file" id="pdf-attachments-7" name="pdf_attachments" accept=".pdf" data-attachment-input="true">
                                    <div class="existing-attachments mt-2" data-attachment-list></div>
                                    <div class="invalid-feedback">
                                        หากมีไฟล์ประกอบสามารถแนบ PDF ได้
                                    </div>
                    ...
                    <div class="card-body border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="col-xl-12 mb-2">
                                    <label for="pdf-attachments-8" class="form-label mt-2">เอกสารแนบ: (PDF)</label>
                                    <input class="form-control" type="file" id="pdf-attachments-8" name="pdf_attachments" accept=".pdf" data-attachment-input="true">
                                    <div class="existing-attachments mt-2" data-attachment-list></div>
                                    <div class="invalid-feedback">
                                        หากมีไฟล์ประกอบสามารถแนบ PDF ได้
                                    </div>
                    ...
                    <div class="card-body border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="col-xl-12 mb-2">
                                    <label for="pdf-attachments-9" class="form-label mt-2">เอกสารแนบ: (PDF)</label>
                                    <input class="form-control" type="file" id="pdf-attachments-9" name="pdf_attachments" accept=".pdf" data-attachment-input="true">
                                    <div class="existing-attachments mt-2" data-attachment-list></div>
                                    <div class="invalid-feedback">
                                        หากมีไฟล์ประกอบสามารถแนบ PDF ได้
                                    </div>
                    ...
                    <div class="card-body border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-12">
                                ...
                                <div class="col-xl-12 mb-2">
                                    <label for="pdf-attachments-10" class="form-label mt-2">เอกสารแนบ: (PDF)</label>
                                    <input class="form-control" type="file" id="pdf-attachments-10" name="pdf_attachments" accept=".pdf" data-attachment-input="true">
                                    <div class="existing-attachments mt-2" data-attachment-list></div>
                                    <div class="invalid-feedback">
                                        หากมีไฟล์ประกอบสามารถแนบ PDF ได้
                                    </div>
