...
class InvestmentBudgetReportManager {
  ...
  exportToExcel(tab = null) {
    ...
    try {
      ...
      const data = this.data[currentTab] || [];
  ...
  async exportSAPReport() {
    ...
    try {
      ...
      // กรองข้อมูลเฉพาะรายการที่ sap_status ไม่ใช่ 'success'
      const filteredData = allData.filter(
        (item) => item.sap_status !== 'success'
      );

      //console.log('🔍 Total data before filter:', filteredData);
