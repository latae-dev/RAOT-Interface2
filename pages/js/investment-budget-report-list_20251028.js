  ...
  renderEquipmentTab(data, startIndex) {
    ...
    const rows = data
      .map((item, i) => {
        ...
        const cursorStyle = isSapSuccess
        ...
        return `
          ...
          item.sap_status || ''
        }" ${cursorStyle}>${this.escapeHtml(equipmentCodeTypeLabel)}</td>
          ...
          item.sap_status || ''
        }" ${cursorStyle}>${this.escapeHtml(equipmentTypeLabel)}</td>
                <td class="${modalCellClass}" ${modalToggle} data-bs-target="#modal-count-units" data-field="count_units" data-id="${
          item.id
        }" data-value="${this.escapeAttr(countUnitValue)}" data-sap-status="${
          item.sap_status || ''
        }" ${cursorStyle}>${this.escapeHtml(countUnitLabel)}</td>
                <td>
