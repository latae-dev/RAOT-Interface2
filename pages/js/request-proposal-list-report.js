...
$(document).ready(function() {
    ...
    /**
     * สร้างปุ่มการจัดการ (แสดงได้อย่างเดียว)
     */
    function getActionButtons(proposal) {
        ...
        // ไม่แสดงปุ่มแก้ไขและลบ - แสดงได้อย่างเดียว
    ...
    function exportToExcel() {
        ...
        try {
            ...
            XLSX.utils.book_append_sheet(workbook, worksheet, 'รายงานคำขอ');
            
            // สร้างชื่อไฟล์
            const fileName = `รายงานคำขอสร้างใบขอเสนอ_${getCurrentDate()}.xlsx`;
