            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="../parcel/pages/withdraw-money-list.php" class="side-menu__item">รายการคำขอเบิกเงินทดรองจ่าย</a>
                        </li>
                        <!-- <li class="slide">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="business-budget-list.php" class="side-menu__item">รายการคำของบประมาณรายจ่ายประจําปี</a>
                        </li>
                        ...
                        <?php
                            ...
                            <li class="slide has-sub" id="approval-menu-1">
                                ...
                                <ul class="slide-menu child2">
                                    <li class="slide">
                                        <a href="business-budget-approvel-list.php" class="side-menu__item">การอนุมัติคําของบประมาณรายจ่ายประจําปี</a>
                                    </li>
                                </ul>
                            </li>
                        <?php endif; ?>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="investment-budget-list.php" class="side-menu__item">รายการคำขอตั้งงบลงทุน</a>
                        </li>
                        <!-- <li class="slide">
                        ...
                        <li class="slide has-sub" id="proposal-approval-menuib">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="investment-budget-approvel-list.php" class="side-menu__item">การอนุมัติคำขอตั้งงบลงทุน</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="request-proposal-list.php" class="side-menu__item">รายการคำขอสร้างใบขอเสนอ</a>
                        </li>
                        <!-- <li class="slide">
                        ...
                        <li class="slide has-sub" id="proposal-approval-menu">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide">
                                    <a href="request-proposal-approvel-list.php" class="side-menu__item">การอนุมัติคำขอใบขอเสนอ จ้าง/เช่า/ซื้อ</a>
                                </li>
                            </ul>
                        </li>
                    </ul> 
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="parcel-withdrawal-plan-approve-report.php" class="side-menu__item">รายงานแผนการเบิกพัสดุแบบพิมพ์</a>
                        </li>
                        <li class="slide">
                            <a href="parcel-withdrawal-approve-report.php" class="side-menu__item">รายงานใบเบิกพัสดุแบบพิมพ์</a>
                        </li>
                        <li class="slide">
                            <a href="parcel-withdrawal-summary-report.php" class="side-menu__item">รายงานสรุปการเบิกพัสดุแบบพิมม์</a>
                        </li>
                        <li class="slide">
                            <a href="parcel-withdrawal-approve-status-list.php" class="side-menu__item"> รายการสถานะการอนุมัติ</a>
                        </li>
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="business-budget-report-list.php" class="side-menu__item">รายงานการอนุมัติคําของบประมาณรายจ่ายประจําปี</a>
                        </li>
                        <li class="slide">
                            <a href="business-budget-report-interface-sap-list.php" class="side-menu__item">รายงาน Interface ข้อมูลเข้า SAP</a>
                        </li>
                    </ul>
                </li>
                <!-- End -->
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="investment-budget-report-list.php" class="side-menu__item">รายงานคำขอตั้งงบลงทุน</a>
                        </li>
                        <li class="slide">
                            <a href="investment-budget-report-interface-sap-list.php" class="side-menu__item">รายงาน Interface ข้อมูลเข้า SAP</a>
                        </li>
                    </ul>
                </li>
                <!-- End -->
                ...
                <li class="slide has-sub" id="proposal-report-menu">
                    ...
                    <ul class="slide-menu child2">
                        <li class="slide">
                            <a href="request-proposal-list-report.php" class="side-menu__item">รายงานคำขอสร้างใบขอเสนอ</a>
                        </li>
                        <li class="slide">
                            <a href="request-proposal-report-interface-sap-list.php" class="side-menu__item">รายงานคำขอสร้างใบขอเสนอ (เชื่อมโยง SAP)</a>
                        </li>
                    </ul>
                </li>
                <!-- End -->
                ...
                <ul class="slide-menu child1">
                    ...
                    <li class="slide has-sub">
                        ...
                        <ul class="slide-menu child2">
                            <li class="slide">
                                <a href="params-quarter-list.php" class="side-menu__item">การจัดการไตรมาส</a>
                            </li>
                            <li class="slide">
