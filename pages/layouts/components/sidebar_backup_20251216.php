    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <!-- Start::slide__รายงาน -->
                <li class="slide__category" id="report-menu"><span class="category-name">รายงาน</span></li>

                <!-- Start::รายงานบริหารจัดการข้อมูลพัสดุ -->
                <li class="slide has-sub" id="report-menu-pacel1">
                    <a href="javascript:void(0);" class="side-menu__item">
                ...
                <li class="slide has-sub" id="report-menu-butget1">
                    <a href="javascript:void(0);" class="side-menu__item">
                        <i class="bx bxs-report side-menu__icon"></i>
                ...
                <li class="slide has-sub" id="report-menu-invesment1">
                    <a href="javascript:void(0);" class="side-menu__item">
                        <i class="bx bxs-report side-menu__icon"></i>
                ...
                <li class="slide has-sub" id="report-menu-proposal1">
                    <a href="javascript:void(0);" class="side-menu__item">
                        <i class="bx bxs-report side-menu__icon"></i>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (posId !== 2 && posId !== 3 && posId !== 4 && posId !== 7 && posId !== 8 && posId !== 9 && posId !== 10 && posId !== 11) {
            document.getElementById("report-menu")?.style && (document.getElementById("report-menu").style.display = "none");
        }

        if (posId !== 10) {
            document.getElementById("report-menu-pacel1")?.style && (document.getElementById("report-menu-pacel1").style.display = "none");
        }

        if (posId !== 2 && posId !== 3 && posId !== 4 && posId !== 7 && posId !== 8) {
            document.getElementById("report-menu-butget1")?.style && (document.getElementById("report-menu-butget1").style.display = "none");
        }

        if (posId !== 2 && posId !== 3 && posId !== 4 && posId !== 9) {
            document.getElementById("report-menu-invesment1")?.style && (document.getElementById("report-menu-invesment1").style.display = "none");
        }

        if (posId !== 11) {
            document.getElementById("report-menu-proposal1")?.style && (document.getElementById("report-menu-proposal1").style.display = "none");
        }
