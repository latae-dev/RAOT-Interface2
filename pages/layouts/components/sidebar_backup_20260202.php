            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">รายงานบริหารจัดการข้อมูลพัสดุ1</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (hasMatchAPHOP) {
            ...
            $('.APHO-only').hide();
            $('.hasAPHOP').text('ระบบเงินสดย่อย');
        }

        // Position ID 3 = ผู้จัดการ, Position ID 11 = ผู้อนุมัติ : PR Online
        ...
        // Position ID 3 = ผู้จัดการ, Position ID 11 = ผู้อนุมัติ : พัสดุคงคลัง
        ...
        // Position ID 3 = ผู้จัดการ, Position ID 11 = ผู้อนุมัติ : งบลงทุน
        if (posId !== 2 && posId !== 3 && posId !== 4 && posId !== 11) {
        ...
        // if (posId !== 1) {
        //     document.getElementById("menu-report-pacel-lable")?.style && (document.getElementById("menu-report-pacel-lable").style.display = "none");
        //     document.getElementById("menu-report-pacel")?.style && (document.getElementById("menu-report-pacel").style.display = "none");
        // }
    });
