...
<?php ob_start(); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <h1 class="page-title fw-semibold fs-18 mb-0">รายการคำขอสร้างใบขอเสนอ</h1>
                        <div class="ms-md-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item"><a href="javascript:void(0);">ระบบจัดซื้อ</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">รายการคำขอสร้างใบขอเสนอ</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    <div class="card-title">รายการคำขอสร้างใบขอเสนอ</div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="text-center">
                                                <a class="btn btn-success m-1" href="request-proposal-form.php"><i class="ri-add-fill me-1 fw-semibold align-middle"></i>คำขอสร้างใบขอเสนอ</a>
...
<?php ob_start(); ?>
        ...
        <script src="<?php echo $baseUrl; ?>/pages/js/request-proposal-form-list.js"></script>
