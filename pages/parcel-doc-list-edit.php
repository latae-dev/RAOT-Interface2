...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">แก้ไขเอกสารใบเบิกเบิกพัสดุแบบพิมพ์</h1>
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0);">ระบบบริหารจัดการข้อมูลพัสดุ</a></li>
                    <li class="breadcrumb-item active" aria-current="page">แก้ไขเอกสารใบเบิกเบิกพัสดุแบบพิมพ์</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    <div class="card-title">แบบฟอร์มใบเบิกพัสดุแบบพิมพ์ เลขที่อ้างอิงแผนเอกสาร: <span name="doc_number"></span></div>
                </div>
                ...
                <div class="card-body px-2 py-4 px-sm-4 border-bottom">
                    <div class="row">
                        ...
                        <div class="col-xl-3 mb-2">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input name="doc_start" type="text" class="form-control" id="date" placeholder="กำหนด วันเริ่มต้น">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 mb-2">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                    <input name="doc_end" type="text" class="form-control" id="date" placeholder="กำหนด วันสิ้นสุด">
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 mb-2" style="display: none;">
                        ...
                        <div class="col-xl-3 mb-2">
                            <label for="input-label11" class="form-label">ไตรมาส :</label>
                            <input name="quarter" type="text" class="form-control" id="input-label11" disabled>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="input-group input-group-sm mb-3">
                                                    ...
                                                    <input name="time_deli_doc" type="text" class="form-control flatpickr-input" id="timepickr1" placeholder="กรุณากรอก เวลาส่งตามแผน" readonly="readonly">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input name="time_pick_doc" type="text" class="form-control flatpickr-input" id="timepickr1" placeholder="กรุณากรอก เวลาในการรับส่ง" readonly="readonly">
                                                    <div class="input-group-text text-muted"> <i class="ri-time-line"></i></div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="px-4 py-3 border-block-start-dashed d-sm-flex justify-content-end">
                    ...
                    <button id="updateData" class="btn btn-primary btn-wave waves-effect waves-light m-1">
                        <i class='bx bxs-save'></i> บันทึกการแก้ไข
                    </button>
                </div>
            </div>
        </div>
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/parcel-doc-list-edit.js"></script>