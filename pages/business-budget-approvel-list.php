<?php
    ...
    $pathUrl = $baseUrl . '/pages/business-budget-approvel-form.php';
?>
...
<?php 
    ...
    $param['permission_approve'] = true;

    $businessList = $controller->getBusinessApproveList($param);
?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="text-center">
                                                    <button id="searchBtn" class="btn btn-primary m-1" fdprocessedid="r987k"><i class="bi bi-search me-1 fw-semibold align-middle"></i>ค้นหา</button>
                                                    <a href="business-budget-approvel-list.php" id="resetBtn" class="btn btn-warning m-1" fdprocessedid="aly3wf"><i class="bi bi-eraser-fill me-1 fw-semibold align-middle"></i>ล้างการค้นหา</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                                    ...
                                                    <?php if($businessList): ?>
                                                        <?php foreach($businessList as $key => $rs): ?>
                                                            <tr class="crm-contact text-center">
                                                                ...
                                                                <td><?php echo $rs['request_name']; ?></td>
                                                                <td><?php echo $rs['depart_name']; ?></td>
                                                                <td><span class="badge rounded-pill bg-warning"><?php echo getStatus($rs['status'], $rs['approve_position_code'], $rs['responsibilities_approves']); ?></span></td>
                                                                <td>
                                                                    <div class="hstack gap-2 fs-15">
                                                                        <!--<a href="<?php echo $pathUrl . '?id=' . $rs['id']; ?>" class="btn btn-icon btn-sm btn-success-transparent rounded-pill">
                                                                            <i class="fe fe-eye"></i>
                                                                        </a>
                                                                        <a href="javascript:void(0);" class="btn btn-icon btn-sm btn-success-transparent rounded-pill" title="รายละเอียดคำขอ">
                                                                            <i class="fe fe-eye"></i>
                                                                        </a>-->
                                                                        <a href="<?php echo $pathUrl . '?id=' . $rs['id']; ?>" class="btn btn-icon btn-sm btn-warning-transparent rounded-pill" title="การพิจารณาอนุมัติ">
                                                                            <i class="bx bx-list-check"></i>
                                                                        </a>
                                                                        <?php if($rs['status'] == 'rejected'): ?>
                                                                            <a href="<?php echo $pathUrl . '?id=' . $rs['id']; ?>" class="btn btn-icon btn-sm btn-danger-transparent rounded-pill">
