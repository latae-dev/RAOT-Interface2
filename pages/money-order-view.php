                            ...
                            <table class="table text-nowrap table-bordered border-success">
                                <thead class="text-center">
                                    <tr>
                                        ...
                                        <td scope="col" rowspan="2" width="4%" class="bg-info text-fixed-dark bg-opacity-25">รหัสรายการ</td>
                                        <td scope="col" rowspan="2" width="4%" class="bg-info text-fixed-dark bg-opacity-25">รายการ</td>
