...
$expenses_moving_total         = arabicToThaiNumber(number_format($main['expenses_moving_total'], 2));
...
$plan_total                    = arabicToThaiNumber($main['plan_total']);
$expenses_amount               = arabicToThaiNumber(number_format($main['expenses_amount'], 2));
