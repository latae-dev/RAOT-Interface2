                        ...
                        <div class="tab-pane fade show active border-0 p-0" id="all-tab-pane" role="tabpanel" tabindex="0">
                            <div class="card-body border-bottom">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <button id="export-excel-all-tab-btn" class="btn btn-success btn-sm"><i class="bx bx-export me-1"></i>Export Excel คำขอรอพิจารณา</button>
                                </div>
                                    ...
                                    <table class="table text-nowrap table-bordered">
                                        <thead class="text-center">
                                            <tr>
                                                ...
                                                <th scope="col">ผลการอนุมัติงบประมาณ</th>
                                                <th scope="col" style="width:200px;">การจัดการ</th>
                                            </tr>
                                        </thead>
                                        <tbody id="all-tbody">
                                            <tr>
                                ...
                                <div class="table-responsive mt-2">
                                    <table class="table text-nowrap table-bordered" id="construction-table">
                                        ...
                                        <tbody id="construction-tbody">
                                            <tr>
                                                <td colspan="13" class="text-center">กำลังโหลดข้อมูล...</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
