...
<div class="container-fluid">
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <h1 class="page-title fw-semibold fs-18 mb-0">แก้ไขคำขอเบิกเงินทดรองจ่าย</h1>
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item fw-semibold"><a href="javascript:void(0);">ระบบเงินสดย่อยและเงินทดรองจ่าย</a></li>
                    <li class="breadcrumb-item fw-semibold active" aria-current="page">แก้ไขแบบฟอร์มคำขอเบิกเงินทดรองจ่าย</li>
                </ol>
            </nav>
        </div>
    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 mb-2">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="date" name="plan_start" placeholder="กรุณากรอก วันและเวลาเริ่มต้น">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 mb-2">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                        <input type="text" class="form-control" id="date" name="plan_end" placeholder="กรุณากรอก วันและเวลาสิ้นสุด">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 mb-2">
                                    ...
                                    <table class="table text-nowrap  table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col" style="width: 100px;">หน่วย</th>
                    ...
                    <div class="card-body px-2 py-4 px-sm-4 border-bottom">
                        <div class="row">
                            <div class="col-xl-3">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input money_receipt" type="checkbox" value="" id="money_receipt">
                            ...
                            <div class="col-xl-9">
                                <div class="form-check mb-2">
                                    ...
                                    <textarea class="form-control note" id="note" name="note" rows=""></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/withdraw-money-plan-edit.js"></script>