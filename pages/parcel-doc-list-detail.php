        ...
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item fw-semibold active" aria-current="page">รายละเอียดใบเบิกเบิกพัสดุแบบพิมพ์</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <div class="px-4 py-3 border-block-start-dashed d-sm-flex justify-content-end">
                    <a class="btn btn-warning btn-wave waves-effect waves-light m-1" href="parcel-doc-list.php"><i class='bx bx-undo'></i></i> ย้อนกลับเมนู</a>
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/parcel-doc-list-detail.js"></script>