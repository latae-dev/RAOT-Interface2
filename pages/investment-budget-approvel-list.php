    ...
    function loadUserHierarchyInfo() {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                // API ใหม่ส่ง hierarchy info มาใน data.data โดยตรง
                if (data.status === 'success' && data.data) {
                    const debug = data.data;
                    console.log('✅ Hierarchy info found:', debug);
                    ...
                    console.warn('⚠️ No debug_info found in response');
