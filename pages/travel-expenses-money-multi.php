        ...
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li aria-current="page" class="breadcrumb-item fw-semibold active">แบบฟอร์มเบิกค่าใช้จ่ายในการเดินทางไปปฏิบัติงาน</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="card-body px-2 py-4 px-sm-4 border-bottom">
                        <div class="row">
                            <div class="col-xl-3 mb-2">
                                ...
                                <input class="form-control bg-light" id="expenses_form_name" name="expenses_form_name" readonly="" type="text" value="เบิกค่าใช้จ่ายในการเดินทางไปปฏิบัติงาน" />
                            </div>
                            <div class="col-xl-3 mb-2">
                            ...
                            <div class="col-xl-12 mb-2" id="ifYes" style="display: none;">
                                ...
                                <div class="table-responsive mb-2">
                                    <table class="table text-nowrap table-bordered border-success" id="groupPeopleTable">
                                        <thead class="text-center">
                                            <tr>
                                                <td class="bg-info text-fixed-dark bg-opacity-25" rowspan="3" scope="col">ลำดับที่</td>
                                                <td class="bg-info text-fixed-dark bg-opacity-25" rowspan="3" scope="col">ชื่อ-นามสกุล</td>
                                                <td class="bg-info text-fixed-dark bg-opacity-25" rowspan="3" scope="col">ตำแหน่ง/ระดับ</td>
                                                <td class="bg-info text-fixed-dark bg-opacity-25" colspan="11" scope="col">ค่าใช้จ่าย (บาท)</td>
                                                <td class="bg-info text-fixed-dark bg-opacity-25" rowspan="3" scope="col">รวม (บาท)</td>
                                            </tr>
                                            <tr>
                                                <td class="bg-info text-fixed-dark bg-opacity-10" colspan="3" scope="col">ค่าเบี้ยเลี้ยง</td>
                                                <td class="bg-info text-fixed-dark bg-opacity-10" colspan="3" scope="col">ค่าเช่าที่พัก</td>
                                                <td class="bg-info text-fixed-dark bg-opacity-10" rowspan="2" scope="col">ค่าพาหนะ</td>
                                                <td class="bg-info text-fixed-dark bg-opacity-10" rowspan="2" scope="col">ค่าใช้จ่ายอื่นๆ</td>
                                                <td class="bg-info text-fixed-dark bg-opacity-10" colspan="3" scope="col">หักค่าอาหารฝึกอบรม</td>
                                            </tr>
                                            <tr>
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body px-2 py-4 px-sm-4 border-bottom">
                        ...
                        <div class="row">
                            <div class="col-xl-3">
                                <div class="form-check mb-2">
                                    <input class="form-check-input approve" id="approve" type="checkbox" value="" />
                                    <label class="form-check-label" for="approve">อนุมัติ</label>
                                </div>
                                <div class="form-check mb-2">
                                    <input class="form-check-input reject" id="reject" type="checkbox" value="" />
...
<!-- This code use for render base file -->
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/travel-expenses-money-multi.js"></script>
<script>
