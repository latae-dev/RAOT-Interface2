                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 mb-2">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control js-flatpickr-datetime" name="expenses_start" id="expenses_start">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 mb-2">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                        <input type="text" class="form-control js-flatpickr-datetime" name="expenses_end" id="expenses_end">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 mb-2">
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/travel-expenses-money-plan-multi.js"></script>
