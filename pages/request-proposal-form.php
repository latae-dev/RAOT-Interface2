                                ...
                                <div class="card-body px-2 py-4 px-sm-4 border-bottom">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 mb-2">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="start_date" id="start-date" placeholder="กำหนด วันเริ่มต้น">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 mb-2">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                                    <input type="text" class="form-control" name="end_date" id="end-date" placeholder="กำหนด วันสิ้นสุด">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 mb-2">
                                        ...
                                        <div class="col-xl-6 mb-2">
                                            ...
                                            <textarea class="form-control" name="header_note" rows="2" placeholder="กรุณากรอก บันทึกส่วนหัว"></textarea>
                                        </div>
                                        <div class="col-xl-6 mb-2">
                                        ...
                                        <div class="col-xl-3 mb-2">
                                            ...
                                            <select class="form-control" name="account_category_id" id="account-category-select" style="width: 100%">
                                                <option value="">กรุณาเลือก</option>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-2">
                                            ...
                                            <div class="row">
                                                <div class="col-6 mb-2">
                                                    <select class="form-control monetary-unit-select" id="monetary-unit-en-select" name="monetary_unit_en" style="width: 100%">
                                                        <option value="">กรุณาเลือกหน่วยเงิน</option>
                                                    </select>
                                                </div>
                                                <div class="col-6 mb-2">
                                                    <select class="form-control monetary-unit-th-select" id="monetary-unit-th-select" name="monetary_unit_th" style="width: 100%">
                                                        <option value="">กรุณาเลือกหน่วยเงิน</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-2 mb-2">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                                    <input type="text" class="form-control" name="delivery_date" id="delivery-date" placeholder="กำหนด วันที่ส่งมอบ">
                                                </div>
                                            </div>
                                        </div>                                      
                                        <div class="col-xl-3 mb-2">
...
<?php ob_start(); ?>
        ...
        <script src="<?php echo $baseUrl; ?>/pages/js/request-proposal-form.js"></script>
