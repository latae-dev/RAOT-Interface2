...
<?php ob_start(); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
                        <div>
                            <h1 class="page-title fw-semibold fs-18 mb-0">รายการสรุปแผนการเบิกพัสดุแบบพิมพ์</h1>
                            <div class="mt-2">
                        ...
                        <div class="ms-md-1 ms-0">
                            <nav>
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item fw-semibold active" aria-current="page">รายการสรุปแผนการเบิกพัสดุแบบพิมพ์</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card custom-card">
                                <div class="card-header justify-content-between">
                                    <div class="card-title">รายการสรุปแผนการเบิกพัสดุแบบพิมพ์</div>
                                </div>
                                            ...
                                            <table class="table text-nowrap table-bordered">
                                                <thead class="text-center">
                                                    <tr>
                                                        ...
                                                        <th scope="col">รหัสแผนการเบิกพัสดุแบบพิมพ์</th>
                                                ...
                                                <!-- <tbody class="text-center">
                                                    <tr class="product-list"  style="width:50px;">
                                                        ...
                                                        <td>01-03-2567</td>
                                                        <td>680013</td>
                                                        <td>แผนการเบิกพัสดุแบบพิมพ์</td>
                                                        <td>นายทดสอบ ทดสอบ</td>
                                                        <td><span class="badge rounded-pill bg-warning">รออนุมัติ</span></td>
                                                    </tr>
                                                    <tr class="product-list">
                                                        ...
                                                        <td>680015</td>
                                                        <td>แผนการเบิกพัสดุแบบพิมพ์</td>
                                                        <td>นายโทดสอบ โทดสอบ</td>
                                                        <td><span class="badge rounded-pill bg-success">อนุมัติ</span></td>
                                                    </tr>
                                                </tbody> -->
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/parcel-withdrawal-plan-approve-report.js"></script>