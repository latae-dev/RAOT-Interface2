            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <div class="card-body px-2 py-4 px-sm-4 border-bottom">
                        ...
                        <div class="row">
                            <div class="col-xl-3">
                                <div class="form-check mb-2 div_approve" style="display:none;">
                                ...
                                <div class="form-check mb-2 div_reject" style="display:none;">
                                ...
                                <div class="form-check mb-2 div_check" style="display:none;">
                                ...
                                <div class="form-check mb-2 div_reject_check" style="display:none;">
                                ...
                                <div class="form-check mb-2 div_check_and_approve" style="display:none;">
...
<script>
    ...
    function loadMainScripts() {
        ...
        script.type = "module";
        script.src = "<?php echo $baseUrl; ?>/pages/js/withdraw-money-approvel-plan-update.js";
