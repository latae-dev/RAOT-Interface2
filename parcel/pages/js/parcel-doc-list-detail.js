...
function addDataNewRow(item) {
    ...
    <td style="display: none;" class="text-end">${item.quantity_total || 0}</td>
    `;
...
function addDataPlan(item) {
    ...
    switch (item.status_doc) {
        case "pending":
            ...
            document.querySelector('span[name="status_doc"]').innerHTML = '<span class="text-warning">รออนุมัติ</span>';
            break;
        case "approve":
            document.querySelector('span[name="status_doc"]').innerHTML = '<span class="text-success">อนุมัติ</span>';
            break;
        case "reject":
            document.querySelector('span[name="status_doc"]').innerHTML = '<span class="text-danger">ไม่อนุมัติ</span>';
            break;
        case "edit":
            document.querySelector('span[name="status_doc"]').innerHTML = '<span class="text-light">ต้องแก้ไข</span>';
            break;
        case "delete":
            document.querySelector('span[name="status_doc"]').innerHTML = '<span class="text-light">เอกสารถูกลบ</span>';
            break;
    }
}
