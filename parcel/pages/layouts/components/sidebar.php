<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar" style="max-width: 15rem;width: 15rem;" id="sidebar-scroll">
            ...
            <ul class="main-menu">
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label hasAPHOP">ระบบเงินยืมทดรอง</span>
                        <i class="fe fe-chevron-right side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0);" class="hasAPHOP">ระบบเงินยืมทดรอง</a>
                        </li>
                        <li class="slide APHO-only">
                        ...
                        <li class="slide has-sub" id="report-menu">
                            ...
                            <ul class="slide-menu child2">
                                <li class="slide APHO-only">
                                    <a href="withdraw-money-plan-report.php" class="side-menu__item">รายงานเงินทดรอง</a>
                                </li>
                                <li class="slide APHOP-only">
                                    <a href="travel-expenses-report.php" class="side-menu__item">รายงานใบเบิกค่าเดินทางปฎิบัติงาน</a>
                                </li>
                                <li class="slide APHOP-only">
                                    <a href="money-order-report.php" class="side-menu__item">รายงานใบสั่งจ่าย</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <!-- Start::คำขอเบิกค่าใช้จ่ายในการเดินทางไปปฏิบัติงาน -->
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide">
                            <a href="business-budget-list.php" class="side-menu__item">รายกาคําของบประมาณรายจ่ายประจําปี</a>
                        </li>
                        ...
                        <li class="slide">
                            <a href="business-budget-report-list" class="side-menu__item">รายงานการอนุมัติคําของบประมาณรายจ่ายประจําปี</a>
                        </li>

                        <li class="slide">
                            <a href="business-budget-report-interface-sap-list" class="side-menu__item">รายงาน Interface ข้อมูลเข้า SAP</a>
                        </li>
                ...
                <!-- end: คำขอเบิกค่าใช้จ่ายในการเดินทางไปปฏิบัติงาน -->
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const hasMatchAll = userData?.position_list_id
            .some(id => ['5', '6', '12', '13'].includes(id));
        const hasMatchAPHO = userData?.position_list_id
            .some(id => ['5'].includes(id));
        const hasMatchAPHOP = userData?.position_list_id
