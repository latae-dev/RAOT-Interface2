                ...
                <div class="form-group col-xl-6 mb-2">
                    ...
                    <select class="form-control" data-trigger name="budget_source_code" id="budget_source_code" <?php echo $permission; ?> required>
                        ...
                        <?php foreach($budgetSource as $key => $rs): ?>
                            <option value="<?php echo $rs['id']; ?>" <?php echo (isset($info) && $info['budget_source_code'] == $rs['id'] ? 'selected' : null); ?>><?php echo $rs['full_name']; ?></option>
                        <?php endforeach; ?>
                    </select>                            
                </div>
            </div>                                
                            ...
                            <table class="table text-nowrap table-bordered">
                                        ...
                                        <tbody class="text-center group" data-group="<?php echo $key; ?>">
                                            <?php foreach($arr as $key2 => $rs): ?>
                                                <tr class="product-list">
                                                    ...
                                                    <td class="fw-normal text_box" style="text-align: left; width:10%"><input type="text" required <?php echo $permission; ?> <?php echo $permission; ?> class="border-0 input_number price" value="<?php echo $rs['price']; ?>" name="activities[<?php echo $key; ?>][price][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left; width:10%"><input type="text" <?php echo $permission; ?> class="border-0 amount" readonly  value="<?php echo $rs['amount']; ?>" name="activities[<?php echo $key; ?>][amount][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left; width:10%"><input type="text" <?php echo $permission; ?> class="border-0 total_amount" value="<?php echo $rs['total_amount']; ?>" readonly name="activities[<?php echo $key; ?>][total_amount][]" style="width:100%"></td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td><input class="form-control total_summary_amount" type="number" value="<?php echo (isset($info) && $info['activity_budgets']) ? $info['activity_budgets']['total_summary_amount'] : 0; ?>" placeholder="0.00" disabled></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                            ...
                            <table class="table table-bordered">
                                        ...
                                        <tbody class="text-center group" data-group="<?php echo $key; ?>">
                                            <?php foreach($arr as $key2 => $rs): ?>
                                                ...
                                                <tr class="box">
                                                    ...
                                                    <td class="fw-normal text_box" style="text-align: left; width:5%"><input type="text" <?php echo $permission; ?> class="border-0 input_number people" value="<?php echo $rs['people']; ?>" name="expenses[<?php echo $key; ?>][people][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left; width:5%"><input type="text" <?php echo $permission; ?> class="border-0 input_number work_days" value="<?php echo $rs['work_days']; ?>" name="expenses[<?php echo $key; ?>][work_days][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left;"><input type="text" <?php echo $permission; ?> class="border-0 input_number allowance_rate" value="<?php echo $rs['allowance_rate']; ?>" name="expenses[<?php echo $key; ?>][allowance_rate][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left; width:7%"><input type="text" <?php echo $permission; ?> <?php echo $permission; ?> class="border-0 input_number allowance_amount" value="<?php echo $rs['allowance_amount']; ?>" readonly name="expenses[<?php echo $key; ?>][allowance_amount][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left;"><input type="text" <?php echo $permission; ?> class="border-0 input_number transport_rate" value="<?php echo $rs['transport_rate']; ?>" name="expenses[<?php echo $key; ?>][transport_rate][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left; width:7%"><input type="text" <?php echo $permission; ?> class="border-0 transport_amount" value="<?php echo $rs['transport_amount']; ?>" readonly name="expenses[<?php echo $key; ?>][transport_amount][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left; width:7%"><input type="text" <?php echo $permission; ?> class="border-0 input_number stay_days" value="<?php echo $rs['stay_days']; ?>" name="expenses[<?php echo $key; ?>][stay_days][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left;"><input type="text" <?php echo $permission; ?> class="border-0 input_number stay_rate" value="<?php echo $rs['stay_rate']; ?>" name="expenses[<?php echo $key; ?>][stay_rate][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left; width:7%"><input type="text" <?php echo $permission; ?> class="border-0 stay_amount" value="<?php echo $rs['stay_amount']; ?>" readonly name="expenses[<?php echo $key; ?>][stay_amount][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left; width:7%"><input type="text" <?php echo $permission; ?> class="border-0 input_number fuel_trips" value="<?php echo $rs['fuel_trips']; ?>" name="expenses[<?php echo $key; ?>][fuel_trips][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left;"><input type="text" <?php echo $permission; ?> class="border-0 input_number fuel_rate" value="<?php echo $rs['fuel_rate']; ?>" name="expenses[<?php echo $key; ?>][fuel_rate][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left; width:7%"><input type="text" <?php echo $permission; ?> class="border-0 fuel_amount" value="<?php echo $rs['fuel_amount']; ?>" readonly name="expenses[<?php echo $key; ?>][fuel_amount][]" style="width:100%"></td>
                                                    <td class="fw-normal text_box" style="text-align: left; width:10%"><input type="text" <?php echo $permission; ?> class="border-0 total_activity" value="<?php echo $rs['total_activity']; ?>" readonly name="expenses[<?php echo $key; ?>][total_activity][]" style="width:100%"></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
                                    <?php endforeach; ?>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td colspan="2"><input class="form-control total_summary_allowance" value="<?php echo (isset($info) && $info['expenses_budgets']) ? $info['expenses_budgets']['total_summary_allowance'] : 0; ?>" type="number" placeholder="0.00" readonly></td>
                                        <td colspan="2"><input class="form-control total_summary_transport" value="<?php echo (isset($info) && $info['expenses_budgets']) ? $info['expenses_budgets']['total_summary_transport'] : 0; ?>" type="number" placeholder="0.00" readonly></td>
                                        <td colspan="3"><input class="form-control total_summary_stay" value="<?php echo (isset($info) && $info['expenses_budgets']) ? $info['expenses_budgets']['total_summary_stay'] : 0; ?>" type="number" placeholder="0.00" readonly></td>
                                        <td colspan="3"><input class="form-control total_summary_fuel" value="<?php echo (isset($info) && $info['expenses_budgets']) ? $info['expenses_budgets']['total_summary_fuel'] : 0; ?>" type="number" placeholder="0.00" readonly></td>
                                        <td style="width: 200px;"><input class="form-control total_summary_amount" value="<?php echo (isset($info) && $info['expenses_budgets']) ? $info['expenses_budgets']['total_summary_amount'] : 0; ?>" type="number" placeholder="0.00" readonly></td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
                                ...
                                <?php foreach($info['operations_budgets']['list'] as $key => $arr): ?>
                                    ...
                                    <tbody class="text-center group" data-group="<?php echo $key; ?>">
                                        <?php foreach($arr as $key2 => $rs): ?>
                                            ...
                                            <tr class="box">
                                                ...
                                                <td class="fw-normal text_box" style="text-align: left;"><input type="text" required <?php echo $permission; ?> class="border-0 input_number weight" value="<?php echo $rs['weight']; ?>" name="operations[<?php echo $key; ?>][weight][]" style="width:100%"></td>
                                                ...
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number oct" value="<?php echo $rs['oct']; ?>" name="operations[<?php echo $key; ?>][oct][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number nov" value="<?php echo $rs['nov']; ?>" name="operations[<?php echo $key; ?>][nov][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number dec" value="<?php echo $rs['dec']; ?>" name="operations[<?php echo $key; ?>][dec][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number jan" value="<?php echo $rs['jan']; ?>" name="operations[<?php echo $key; ?>][jan][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number feb" value="<?php echo $rs['feb']; ?>" name="operations[<?php echo $key; ?>][feb][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number mar" value="<?php echo $rs['mar']; ?>" name="operations[<?php echo $key; ?>][mar][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number apr" value="<?php echo $rs['apr']; ?>" name="operations[<?php echo $key; ?>][apr][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number may" value="<?php echo $rs['may']; ?>" name="operations[<?php echo $key; ?>][may][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number jun" value="<?php echo $rs['jun']; ?>" name="operations[<?php echo $key; ?>][jun][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number jul" value="<?php echo $rs['jul']; ?>" name="operations[<?php echo $key; ?>][jul][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number aug" value="<?php echo $rs['aug']; ?>" name="operations[<?php echo $key; ?>][aug][]"></td>
                                                <td class="fw-normal text_box"><input type="text" <?php echo $permission; ?> style="width: 48px;" class="border-0 text-center input_number sep" value="<?php echo $rs['sep']; ?>" name="operations[<?php echo $key; ?>][sep][]"></td>
                                    ...
                                    <tbody class="summary" data-set="<?php echo $key; ?>">
                                        <tr>
                                            ...
                                            <td colspan="16"><input class="form-control total_summary_weight_amount" type="number" value="<?php echo $total_summary_weight_amount; ?>" placeholder="0.00" disabled></td>
                                        </tr>
                                    </tbody>
                                <?php endforeach; ?>
                            <?php else: ?>
                                ...
                                <tbody class="summary" data-set="0">
                                    <tr>
                                        <td scope="col" class="text-end"></td>
                                        <td scope="col"  class="text-end">รวม</td>
                                        <td colspan="16"><input class="form-control total_summary_weight_amount" type="number" value="<?php echo (isset($info) && $info['operations_budgets']) ? $info['operations_budgets']['total_summary_weight_amount'] : 0; ?>" placeholder="0.00" disabled></td>
                                    </tr>
                                </tbody>
                            <?php endif; ?>        
                            <tfoot></tfoot>
                    ...
                    <div class="py-3">
                        <div class="row">
                            <div class="col-xl-6 mb-2">
                                ...
                                <input type="text" <?php echo $permission; ?> class="form-control sec_5_name" id="input-label11" name="name_1" value="<?php echo (isset($info) && $info['name_1']) ? $info['name_1'] : null; ?>" placeholder="กรุณากรอก ชื่อ - สกุล" >
                            </div>
                            <div class="col-xl-6 mb-2">
                                <label class="form-label mt-2">ตําแหน่ง :</label>
                                <input type="text" <?php echo $permission; ?> class="form-control sec_5_position" id="input-label11" name="position_1" value="<?php echo (isset($info) && $info['position_1']) ? $info['position_1'] : null; ?>" placeholder="กรุณากรอก ตําแหน่ง" >
                            </div>
                            <div class="col-xl-6 mb-2">
                                <label class="form-label mt-2">โทรศัพท์ :</label>
                                <input type="text" <?php echo $permission; ?> pattern="^[0-9]{10}$"pattern="^[0-9]{10}$" class="form-control sec_5_tel" id="input-label11" name="tel_1" value="<?php echo (isset($info) && $info['tel_1']) ? $info['tel_1'] : null; ?>" placeholder="กรุณากรอก โทรศัพท์" >
                            </div>
                            <div class="col-xl-6 mb-2">
                                <label class="form-label mt-2">อีเมลล์ :</label>
                                <input type="email" <?php echo $permission; ?> class="form-control sec_5_email" id="input-label11" name="email_1" value="<?php echo (isset($info) && $info['email_1']) ? $info['email_1'] : null; ?>" placeholder="กรุณากรอก อีเมลล์" >
                            </div>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="py-3">
                        <div class="row">
                            <div class="col-xl-6 mb-2">
                                <label class="form-label mt-2">ชื่อ - สกุล :</label>
                                <input type="text" <?php echo $permission; ?> class="form-control sec_5_name" id="input-label11" name="name_2" value="<?php echo (isset($info) && $info['name_2']) ? $info['name_2'] : null; ?>" placeholder="กรุณากรอก ชื่อ - สกุล" >
                            </div>
                            <div class="col-xl-6 mb-2">
                                <label class="form-label mt-2">ตําแหน่ง :</label>
                                <input type="text" <?php echo $permission; ?> <?php echo $permission; ?> class="form-control sec_5_position" id="input-label11" name="position_2" value="<?php echo (isset($info) && $info['position_2']) ? $info['position_2'] : null; ?>" placeholder="กรุณากรอก ตําแหน่ง" >
                            </div>
                            <div class="col-xl-6 mb-2">
                                <label class="form-label mt-2">โทรศัพท์ :</label>
                                <input type="text" <?php echo $permission; ?> pattern="^[0-9]{10}$" class="form-control sec_5_tel" id="input-label11" name="tel_2" value="<?php echo (isset($info) && $info['tel_2']) ? $info['tel_2'] : null; ?>" placeholder="กรุณากรอก โทรศัพท์" >
                            </div>
                            <div class="col-xl-6 mb-2">
                                <label class="form-label mt-2">อีเมลล์ :</label>
                                <input type="email" <?php echo $permission; ?> class="form-control sec_5_email" id="input-label11" name="email_2" value="<?php echo (isset($info) && $info['email_2']) ? $info['email_2'] : null; ?>" placeholder="กรุณากรอก อีเมลล์" >
                            </div>
                        </div>
