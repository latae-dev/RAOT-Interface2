                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 mb-2">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control date-th-datetime" id="date" name="expenses_start">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 mb-2">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                        <input type="text" class="form-control date-th-datetime" id="date" name="expenses_end">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 mb-2">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <div class="card-body px-2 py-4 px-sm-4 border-bottom no_plan_id">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xl-12 mb-2">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 mb-2 mt-2" style="display: none;">
                                        <div class="row">
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 mb-2 mt-2" style="display: none;">
                    ...
                    <div class="card-body border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-12 mb-2 have_plan_id" style="display: none;">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 mb-2 have_plan_id" style="display: none;">
                                <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 mb-2 mb-2 have_plan_id" style="display: none;">
                                <div class="row">
                                    <div class="col-xl-12 mb-2">
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/travel-expenses-money-outside-edit.js"></script>
<script>
    ...
    EventListener('input', function() {
        ...
        document.querySelectorAll('.format-number-0point').forEach(input => {
            input.addalue = this.value.replace(/\./g, '');
        });
        input.addEventListener('blur', function() {
