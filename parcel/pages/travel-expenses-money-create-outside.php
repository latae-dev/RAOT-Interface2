                    ...
                    <div class="card-body px-2 py-4 px-sm-4 border-bottom">
                        <div class="row">
                            <div class="col-xl-3 mb-2">
                                ...
                                <input type="text" class="form-control bg-light" id="expenses_form_name" name="expenses_form_name" value="ใบเบิกค่าใช้จ่ายในการเดินทางไปปฏิบัติงาน (บุคคลภายนอก)" readonly>
                            </div>
                            <div class="col-xl-3 mb-2">
                ...
                <div class="card custom-card">
                    ...
                    <div class="card-body border-bottom">
                        <div class="row">
                            ...
                            <div class="col-xl-6 mb-2 mt-2 div-two-person" style="display: none;">
                                <div class="row">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 mb-2 mt-2 div-two-person" style="display: none;">
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/travel-expenses-money-create-outside.js"></script>
<script>
