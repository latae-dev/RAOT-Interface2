        ...
        <div class="ms-md-1 ms-0">
            <nav>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item fw-semibold active" aria-current="page">แบบฟอร์มเบิกค่าใช้จ่ายในการเดินทางไปปฏิบัติงาน (บุคคลภายนอก)</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="card-body px-2 py-4 px-sm-4 border-bottom">
                        <div class="row">
                            <div class="col-xl-3 mb-2">
                                ...
                                <input type="text" class="form-control bg-light" id="expenses_form_name" name="expenses_form_name" value="เบิกค่าใช้จ่ายในการเดินทางไปปฏิบัติงาน" readonly>
                            </div>
                            <div class="col-xl-3 mb-2">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="expenses_start" name="expenses_start">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 mb-2">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                        <input type="text" class="form-control" id="expenses_end" name="expenses_end">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 mb-2">
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <div class="card-header justify-content-between">
                        <div class="card-title">รายละเอียดการเบิกค่าใช้จ่ายในการเดินทางไปปฏิบัติงาน (บุคคลภายนอก)</div>
                    </div>
                            ...
                            <div class="col-xl-12 mb-2">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 mb-2 one-person">
                                        ...
                                        <input type="text" class="form-control" id="text_approve" name="text_approve" placeholder="กรุณากรอก ได้อนุมัติให้" autocomplete="off">
                                    </div>
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 mb-2 mt-2">
                        ...
                        <div class="row">
                            <div class="col-xl-4 mb-2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <select class="form-select" id="is_foreign" required style="width: 100%">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 mb-2">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                                <input type="text" class="form-control" id="expenses_start_date" name="expenses_start_date" placeholder="กรุณากรอก วันที่เดินทาง">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 mb-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 mb-2">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-text text-muted"> <i class="ri-calendar-line"></i> </div>
                                                <input type="text" class="form-control" id="expenses_end_date" name="expenses_end_date" placeholder="กรุณากรอก วันที่เดินทาง">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-12 mb-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 mb-2">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="expenses_vehicle" id="expenses_motorcycle" value="motorcycle">
                            ...
                            <div class="col-xl-12 mb-2 have_plan_id">
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 mb-2 have_plan_id">
                                <div class="row">
                                    <label class="form-label mb-2">ผู้ใช้งานต้องการ :</label>
                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="expenses_action" id="expenses_return" value="return">
                                            <label class="form-check-label" for="expenses_return">ส่งคืน</label>
                                        </div>
                                    </div>
                                    <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 mb-2">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="expenses_action" id="expenses_withdraw" value="withdraw">
                                            <label class="form-check-label" for="expenses_withdraw">เบิกเพิ่ม</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 mb-2 mb-2 have_plan_id">
                                <div class="row">
                                    <div class="col-xl-12 mb-2">
                                        <label for="expenses_amount" class="form-label">จำนวนเงินที่ต้องการส่งคืน/เบิกเพิ่ม (บาท) :</label>
                                        <input type="text" class="form-control" id="expenses_amount" name="expenses_amount" placeholder="0.00">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="module" src="<?php echo $baseUrl; ?>/pages/js/travel-expenses-money-outside-view.js"></script>
<script>
