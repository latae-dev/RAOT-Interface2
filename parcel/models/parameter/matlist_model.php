...
class MatlistModel
{
    ...
    public function readMatlist()
    {
        $query = "SELECT * FROM parameters.tb_matlists";
    ...
    public function readMatlistOne($id)
    {
        $query = "SELECT * FROM parameters.tb_matlists WHERE id = $1";
