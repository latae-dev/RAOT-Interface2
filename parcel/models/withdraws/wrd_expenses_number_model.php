...
class ExpensesNumberModel
{
    ...
    public function createExpensesNumber()
    {
        ...
        do {
            ...
            $query = "SELECT expenses_number FROM withdraws.tb_wrd_expenses WHERE expenses_number LIKE $1 ORDER BY expenses_number DESC LIMIT 1";
            $result = pg_query_params($this->conn, $query, array($currentYearShort . 'T%'));
            ...
            if ($row) {
                ...
                $lastPlanNumber = $row['expenses_number'];
            ...
            $planNumber = $currentYearShort . 'T' . $runningNumber;
