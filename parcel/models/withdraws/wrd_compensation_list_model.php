...
class WrdCompensationListModel
{
    ...
    public function readCompensationGLListOne($id)
    {
        $query = "SELECT * FROM withdraws.tb_wrd_compensation_gl_lists WHERE compensation_id = $1";
        $result = pg_query_params($this->conn, $query, array($id));
    ...
    public function insertCompensationGLList($data, $id)
    {
        $query = "INSERT INTO withdraws.tb_wrd_compensation_gl_lists (
            compensation_id,
            bath,
            stang,
            created_at,
        ...
        foreach ($data['gl_detail_data'] as $mat) {
