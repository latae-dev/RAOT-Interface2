...
class DocController
{
    ...
    public function readAllSearchlist($doc_type, $limit, $offset, $doc_number, $start_date, $end_date, $status_doc)
    {
        $userData = $_SESSION['user_data'];

        $respond = $this->docModel->readAllSearchlist($doc_type, $limit, $offset, $doc_number, $start_date, $end_date, $status_doc, $userData);
        echo  json_encode($respond);
    }
