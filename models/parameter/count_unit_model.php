...
class CountUnitModel
{
    ...
    public function readCountUnit()
    {
        $query = "SELECT * FROM parameters.tb_count_units";
    ...
    public function readCountUnitOne($id)
    {
        $query = "SELECT * FROM parameters.tb_count_units WHERE id = $1";
