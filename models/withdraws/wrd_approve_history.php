...
class WrdApproveHistoryModel
{
    ...
    public function readAllSearch($key, $limit = 10, $offset = 0, $plan_number = '', $start_date = '', $end_date = '', $status = '', $depart_code = '', $req_user_code = '')
    {
        ...
        // ✅ Query ดึงข้อมูล
        $data_sql = "SELECT id, created_at, updated_at, plan_requ_level, plan_number, st_br, st_pv, st_ar, st_hf, req_user_code, province_name, full_name, plan_form_name, st_hf_user_code, st_ar_user_code, st_pv_user_code, st_br_user_code, req_user_date " . $base_query;
    ...
    public function createApproveLogs($data, $id)
    {
