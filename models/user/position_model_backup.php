...
class PositionModel
{
    ...
    public function createPosition($position_code, $position_name)
    {
        ...
        $query = "INSERT INTO users.tb_positions (position_code, position_name) VALUES ($1, $2)";
        $result = pg_query_params($this->conn, $query, array($position_code, $position_name));
    ...
    public function updatePosition($id, $position_code, $position_name)
    {
        ...
        $query = "UPDATE users.tb_positions SET position_code = $1, position_name = $2 WHERE id = $3";
        $result = pg_query_params($this->conn, $query, array($position_code, $position_name, $id));
